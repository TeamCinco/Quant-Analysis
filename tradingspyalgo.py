...
# Modify the function to include calculations for quarter increments
...
# Modify the code at the end of your script to use this function
...
try:
    ...
    # Update the script to use the new function
